...
class ExpertAssistant:
    ...
    def validate_chronology(self, team1: str, team2: str, date: str, competition: str, chronology_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"is_valid": False, "inconsistencies": "Erro técnico no validador. Por favor, pesquise na web pela súmula oficial e reinsira todos os gols, cartões e substituições reais da partida."}
