...
class ExpertAssistant:
    ...
    def _execute_generation_flow(self, team1: str, team2: str, competition: str, platform: str, date: str, start_timestamp: Optional[int] = None, duration: Optional[int] = None, video_url: Optional[str] = None, transcript_text: Optional[str] = None, directive_correction: str = "") -> Dict[str, Any]:
        ...
        3. CLOCK DO FUTEBOL vs RELÓGIO REAL E INTERVALO:
            - Separe explicitamente o tempo absoluto (Relógio real de Brasília) do tempo futebolístico oficial (ex: 90+8' ou 52:25 do 2T).
    ...
    def validate_chronology(self, team1: str, team2: str, date: str, competition: str, chronology_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        1. Faça uma busca minuciosa na web pela súmula ou minuto a minuto oficial da partida.
        2. Verifique se TODOS os seguintes itens estão 100% corretos:
           - Acréscimos do 1º Tempo (campo 'stoppage_time_1t')
           - Acréscimos do 2º Tempo (campo 'stoppage_time_2t')
           - GOLS: Verifique se todos os gols da partida estão na lista e nos tempos/minutos corretos.
           - CARTÕES: Verifique se todos os cartões (amarelos/vermelhos) da súmula estão listados.
           - SUBSTITUIÇÕES: Verifique se TODAS as substituições de ambos os times estão listadas.
        3. Identifique quaisquer eventos ausentes, tempos/minutos incorretos ou acréscimos divergentes.
        4. O retorno DEVE ser um objeto JSON estrito com esta estrutura:
           {{
             "is_valid": true ou false,
             "inconsistencies": "Descreva aqui detalhadamente o que está errado ou faltando (ex: 'Falta cartão amarelo para Walter aos 89; Acréscimos do 2T devem ser +5 em vez de +2'). Se is_valid for true, deixe este campo vazio."
           }}
