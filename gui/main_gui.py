...
class MonitorApp(MonitorCoreMixin, ctk.CTk):
    ...
    def _build_ui(self) -> None:
        ...
        ctk.CTkEntry(row_inputs, textvariable=self.expert_team1_var, width=140, placeholder_text="Ex: Palmeiras").pack(side="left", padx=(0, 10))

        ctk.CTkLabel(row_inputs, text="Time Fora:").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row_inputs, textvariable=self.expert_team2_var, width=140, placeholder_text="Ex: Flamengo").pack(side="left", padx=(0, 10))

        ctk.CTkLabel(row_inputs, text="Competição:").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row_inputs, textvariable=self.expert_comp_var, width=140, placeholder_text="Ex: Copa do Brasil").pack(side="left", padx=(0, 10))
        ...
        ctk.CTkEntry(row_inputs, textvariable=self.expert_platform_var, width=110, placeholder_text="Ex: Prime Video").pack(side="left", padx=(0, 10))
