...
class MonitorApp(MonitorCoreMixin, ctk.CTk):
    ...
    def _on_mode_change(self, mode: str) -> None:
        ...
        # 1. Painel manual do Expert (FICA NO TOPO EM MODO EXPERT; SOME EM MODO VISUAL OBS)
        ...
        # 2. Barra de Pesquisa do YouTube / Canais (self.top: Tema, Canal, URL) - SEMPRE VISÍVEL EMBAIXO EM AMBOS OS MODOS
        if hasattr(self, "top") and self.top:
            self.top.pack(side="bottom", fill="x", padx=12, pady=(4, 4))

        # 3. URL Manual bar2 - SEMPRE VISÍVEL EMBAIXO EM AMBOS OS MODOS
        if hasattr(self, "bar2") and self.bar2:
            self.bar2.pack(side="bottom", fill="x", padx=12, pady=(0, 8))

        # 4. Painel Telemetria Live OBS (Só no modo Visual OBS)
