...
class MonitorApp(MonitorCoreMixin, ctk.CTk):
    ...
    def _build_ui(self) -> None:
        ...
        ctk.CTkEntry(row_inputs, textvariable=self.expert_time_var, width=70, placeholder_text="Ex: 22:30").pack(side="left", padx=(0, 4))
        ...
        # Seção de Agendamentos e Fila Live (Na Barra Lateral Direita)
        ...
        self.schedule_scroll = ctk.CTkScrollableFrame(self.schedule_frame, fg_color="transparent", height=130)
        ...
        self.cbf_mural_scroll = ctk.CTkScrollableFrame(self.cbf_mural_frame, fg_color="transparent", height=120)
    ...
    def _on_mode_change(self, mode: str) -> None:
        ...
        # Gerenciamento de exibição do painel manual do Expert e da barra OBS Live
        if mode == "Expert (API-Only)":
            if hasattr(self, "expert_manual_frame") and self.expert_manual_frame:
                self.expert_manual_frame.pack(fill="x", padx=12, pady=(0, 8), after=self.bar2)
...
📄 SÚMULA ELETRÔNICA CBF: 100% Validada"""
    ...
    def _apply_preset_data(self, t1: str, t2: str, comp: str, date: str, plat: str) -> None:
    ...
    def _render_cbf_mural_ui(self) -> None:
        """Renderiza o Mural de Próximos Confrontos com os dados oficiais do Streaming_Scheduler."""
        ...
        for evt in cbf_events[:6]:
            ...
            title_lbl = ctk.CTkLabel(card, text=f"⚡ {t1} x {t2}", font=ctk.CTkFont(size=10, weight="bold"), text_color="#00FF00")
            title_lbl.pack(anchor="w", padx=6, pady=(4, 1))
            ...
            btn_apply = ctk.CTkButton(
                ...
                fg_color="#2b5b84",
                hover_color="#1d405f",
                command=lambda _t1=t1, _t2=t2, _c=comp, _d=d_str, _p=plat: self._apply_preset_data(_t1, _t2, _c, _d, _p)
            )
