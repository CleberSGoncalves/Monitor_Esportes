...
class MonitorApp(MonitorCoreMixin, ctk.CTk):
    ...
    def _build_ui(self) -> None:
        ...
        # --- NOVA COLUNA DIREITA: HISTÓRICO ---
        self.right_sidebar = ctk.CTkFrame(main, width=260, corner_radius=14)
        ...
        ctk.CTkLabel(mural_hdr, text="STREAMING", font=ctk.CTkFont(size=9, weight="bold"), text_color="#00CED1").pack(side="right")
    ...
    def _on_mode_change(self, mode: str) -> None:
        ...
        # 4. Switches OBS (Auto-prepare, Auto-start, Modo debug visual)
