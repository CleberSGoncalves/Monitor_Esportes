...
class MonitorApp(MonitorCoreMixin, ctk.CTk):
    ...
    def _build_ui(self) -> None:
        ...
        # Barra de Presets Rápidos de Jogos
        row_presets = ctk.CTkFrame(self.expert_manual_frame, fg_color="transparent")
        row_presets.pack(fill="x", padx=15, pady=(2, 4))
        
        ctk.CTkLabel(row_presets, text="Seleção Rápida:", font=ctk.CTkFont(size=10, weight="bold"), text_color="#AAAAAA").pack(side="left", padx=(0, 6))
        
        def _apply_preset(t1, t2, comp, date, plat):
        ...
        ctk.CTkButton(
            row_presets, text="⚡ Palmeiras x Santos (26/08)", font=ctk.CTkFont(size=10),
            height=22, fg_color="#222222", hover_color="#333333",
            command=lambda: _apply_preset("Palmeiras", "Santos", "Copa do Brasil", "26/08/2026", "Amazon Prime")
        ).pack(side="left", padx=4)

        ctk.CTkButton(
            row_presets, text="⚡ Cruzeiro x Flamengo (22/08)", font=ctk.CTkFont(size=10),
            height=22, fg_color="#222222", hover_color="#333333",
            command=lambda: _apply_preset("Cruzeiro", "Flamengo", "Brasileiro Serie A", "22/08/2026", "Amazon Prime")
        ).pack(side="left", padx=4)

        ctk.CTkButton(
            row_presets, text="⚡ Fluminense x Remo (22/08)", font=ctk.CTkFont(size=10),
            height=22, fg_color="#222222", hover_color="#333333",
            command=lambda: _apply_preset("Fluminense", "Remo", "Brasileiro Serie A", "22/08/2026", "CazéTV")
        ).pack(side="left", padx=4)

        row = ctk.CTkFrame(self.expert_manual_frame, fg_color="transparent")
        row.pack(fill="x", padx=15, pady=(4, 10))

        ctk.CTkLabel(row, text="Time Casa:").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row, textvariable=self.expert_team1_var, width=160, placeholder_text="Ex: Palmeiras").pack(side="left", padx=(0, 12))

        ctk.CTkLabel(row, text="Time Fora:").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row, textvariable=self.expert_team2_var, width=160, placeholder_text="Ex: Flamengo").pack(side="left", padx=(0, 12))

        ctk.CTkLabel(row, text="Competição:").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row, textvariable=self.expert_comp_var, width=160, placeholder_text="Ex: Copa do Brasil").pack(side="left", padx=(0, 12))

        ctk.CTkLabel(row, text="Data:").pack(side="left", padx=(0, 4))
        if DateEntry:
            ...
            self.expert_date_entry.pack(side="left", padx=(0, 2), pady=6)
            ...
            self.btn_cal_expert.pack(side="left", padx=(0, 12), pady=6)
        else:
            self.expert_date_entry = ctk.CTkEntry(row, textvariable=self.expert_date_var, width=120, placeholder_text="DD/MM/YYYY")
            self.expert_date_entry.pack(side="left", padx=(0, 12))

        ctk.CTkLabel(row, text="Plataforma:").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row, textvariable=self.expert_platform_var, width=120, placeholder_text="Ex: Prime Video").pack(side="left", padx=(0, 12))

        ctk.CTkLabel(row, text="Horário (VOD):").pack(side="left", padx=(0, 4))
        ctk.CTkEntry(row, textvariable=self.expert_time_var, width=80, placeholder_text="Ex: 22:30").pack(side="left", padx=(0, 15))
        ...
        btn_view_prompt.pack(side="left", padx=(4, 4))
        ...
        btn_copy_summary.pack(side="left", padx=(4, 4))
        ...
        btn_schedule.pack(side="left", padx=(4, 4))
        ...
        btn_run.pack(side="left", padx=(4, 0))
        ...
        self.schedule_scroll = ctk.CTkScrollableFrame(self.schedule_frame, fg_color="transparent", height=150)
        self.schedule_scroll.pack(fill="x", padx=4, pady=(2, 6))
